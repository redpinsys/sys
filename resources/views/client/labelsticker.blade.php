          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group col-md-12 col-sm-12 col-xs-12">
                ...
                <select2 v-model="form.shape_id" class="form-control">
                    <option value="">All</option>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <input type="text" name="width" class="form-control" v-model="form.width" :class="{ 'is-invalid' : formErrors['width'] }" :placeholder="'Maximum '+formsetup.max_width+'mm'">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <input type="text" name="height" class="form-control" v-model="form.height" :class="{ 'is-invalid' : formErrors['height'] }" :placeholder="'Maximum '+formsetup.max_height+'mm'">
              ...
              <div class="form-group col-md-12 col-sm-12 col-xs-12">
                ...
                <select2 v-model="form.orderquantity_id" class="form-control">
                    <option value="">All</option>
              ...
              <div class="form-group col-md-12 col-sm-12 col-xs-12">
                ...
                <select2 v-model="form.delivery_fee" class="form-control">
              ...
              <div class="form-group col-md-12 col-sm-12 col-xs-12 row pt-3">
                <h4>
                  Total:
                  <span>
